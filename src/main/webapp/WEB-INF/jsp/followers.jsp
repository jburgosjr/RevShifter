...
<body>
          ...
          <ul id="slide-out" class="side-nav fixed z-depth-5 ">
            ...
            <li>
           		<div class="userView">
	            	...
	            	<br>
	            	<br>
	            	<span class="white-text name">Your Followers:</span>
							 ...
							 <ul class="collection listFS">
								<c:forEach items="${following}" var="follow">
									<li class="collection-item avatar ">
								      <a href="/profile/${follow.user.id }"><img src=${follow.user.defaultImage } alt="" class="circle"></a>
								      <a href="/profile/${follow.user.id }"><span class="title text-spacing-list deep-purple-text darken-4">${fn:toUpperCase(fn:substring(follow.user.firstName, 0, 1))}${fn:toLowerCase(fn:substring(follow.user.firstName, 1,fn:length(follow.user.firstName)))} ${fn:toUpperCase(fn:substring(follow.user.lastName, 0, 1))}${fn:toLowerCase(fn:substring(follow.user.lastName, 1,fn:length(follow.user.lastName)))}</span></a>
								      <p class="text-spacing-list">${follow.user.city}<br>
								         ${follow.user.state}
								      </p>
    ...
    <script type="text/javascript" src="/js/followerScript.js"></script>
 </body>
</body>
</html>